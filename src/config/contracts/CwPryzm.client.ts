...
export interface CwPryzmReadOnlyInterface {
  contractAddress: string;
  getCount: () => Promise<GetCountResponse>;
}
export class CwPryzmQueryClient implements CwPryzmReadOnlyInterface {
...
export interface CwPryzmInterface extends CwPryzmReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class CwPryzmClient extends CwPryzmQueryClient implements CwPryzmInterface {
